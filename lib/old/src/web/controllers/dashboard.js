...
router.get("/", (req, res, next) => {
    ...
    */
    ...
    res.render("dashboard/select", { user: { id: "id", username: "username", discriminator: "discriminator", avatar: "avatar", guilds: [] } });
});
...
router.get("/leaderboards", (req, res) => {
    ...
    Server.findById(req.user.currentGuild, (err, server) => {
        ...
        res.render("dashboard/leaderboards", { user: req.user, server: server, v1: v1, v2: v2 });
    });
});
