...
router.route("/").get(authUser, async (req, res) => {
  ...
  const search = {
    ...
    ... req.query.marketplace_enabled === undefined ? { marketplace_enabled: true } : { marketplace_enabled: req.user.admin === false ? true : req.query.marketplace_enabled === "true" } ,
        ...
        .then(async docs => {
          ...
          if (extended === true) {
            ...
            for (let i = 0; i < script_objs.length; i++) {
              ...
              promises.push(client.fetchUser(script_objs[i].author_id, true)
                .then(user => {
  ...
  params = { ...params, ...req.body.name === undefined
    ? {}
    : { name: req.body.name }  };
  params = { ...params, ...req.body.description === undefined
    ? {}
    : { description: req.body.description }  };
  params = { ...params, ...req.body.thumbnail === undefined
    ? {}
    : { thumbnail: req.body.thumbnail }  };
  params = { ...params, ...req.body.marketplace_enabled === undefined
    ? {}
    : { marketplace_enabled: req.body.marketplace_enabled }  };

  params = { ...params, ...req.body.type === undefined
    ? {}
    : { type: req.body.type }  };
  params = { ...params, ...req.body.match_type === undefined
    ? {}
    : { match_type: req.body.match_type }  };
  params = { ...params, ...req.body.match === undefined
    ? {}
    : { match: req.body.match }  };

  params = { ...params, ...req.body.code === undefined
    ? {}
    : { code: req.body.code }  };
  params = { ...params, ...req.body.data === undefined
    ? {}
    : { data: req.body.data }  };

  if (req.user.admin === true) {

    params = { ...params, ...req.body.local === undefined
      ? {}
      : { local: req.body.local }  };
    params = { ...params, ...req.body.featured === undefined
      ? {}
      : { featured: req.body.featured }  };
    params = { ...params, ...req.body.verified === undefined
      ? {}
      : { verified: req.body.verified }  };
    params = { ...params, ...req.body.likes === undefined
      ? {}
      : { likes: req.body.likes }  };
    params = { ...params, ...req.body.guild_count === undefined
      ? {}
      : { guild_count: req.body.guild_count }  };
    params = { ...params, ...req.body.use_count === undefined
      ? {}
      : { use_count: req.body.use_count }  };
  }

  params = { ...params, ...req.body.created_with === undefined
    ? {}
    : { created_with: req.body.created_with }  };
