...
function info(message) {
    ...
    embed.addField("Online Dashboard", "https://awesomobot.tk/")
...
function help(message) {
    ...
    embed.addField("List of Commands", "https://awesomobot.tk/commands")
    embed.addField("Help & Support", "https://help.awesomobot.tk/")
