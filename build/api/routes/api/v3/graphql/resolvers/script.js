...
exports.default = {
    Query: {
        scripts: () => __awaiter(void 0, void 0, void 0, function* () {
            const scripts = yield db_1.scriptService.getMany();
            return scripts;
        }),
        script: (_, variables, context) => __awaiter(void 0, void 0, void 0, function* () {
            var _a;
    ...
    Mutation: {
        addScript: (_, variables, context) => __awaiter(void 0, void 0, void 0, function* () {
            var _b;
        ...
        updateScript: (_, variables, context) => __awaiter(void 0, void 0, void 0, function* () {
            var _c, _d;
        ...
        deleteScript: (_, variables, context) => __awaiter(void 0, void 0, void 0, function* () {
            var _e;
